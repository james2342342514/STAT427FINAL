...
-   The VIF values are:
    ...
    | Variable                     | VIF      |
    |------------------------------|----------|
    | scores_teaching              | 5.336037 |
    | scores_research              | 7.606038 |
    | scores_citations             | 2.252497 |
    | scores_industry_income       | 2.749347 |
    | scores_international_outlook | 3.631838 |
    | stats_number_students        | 1.171036 |
    | stats_student_staff_ratio    | 1.429422 |
    | stats_pc_intl_students       | 2.745453 |
    | female_proportion            | 1.089991 |
    | International_School_binary  | 1.221743 |
...
# Train final model with the best lambda on the training data
final_model <- glmnet(train_predictors, train_response, alpha = 1, lambda = best_lambda)

# Coefficients of the final model
coef(final_model)

# Plot CV error as function of lambda
...
mse <- mean((predictions - test_response)^2)
mse
