...
linear_model2 <- lm(clean_rank ~ scores_teaching + scores_research + scores_citations + scores_industry_income + scores_international_outlook, data = data_clean)
...
linear_model5 <- lm(clean_rank ~ female_proportion, data = data_clean)
